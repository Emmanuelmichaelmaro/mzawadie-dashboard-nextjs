...
export type CollectionTranslations_translations_edges_node =
    | CollectionTranslations_translations_edges_node_ProductTranslatableContent
    | CollectionTranslations_translations_edges_node_CollectionTranslatableContent;
