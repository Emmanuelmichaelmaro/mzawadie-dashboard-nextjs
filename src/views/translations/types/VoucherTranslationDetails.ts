...
export type VoucherTranslationDetails_translation =
    | VoucherTranslationDetails_translation_ProductTranslatableContent
    | VoucherTranslationDetails_translation_VoucherTranslatableContent;
