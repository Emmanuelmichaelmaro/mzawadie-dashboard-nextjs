...
export type SaleTranslations_translations_edges_node =
    | SaleTranslations_translations_edges_node_ProductTranslatableContent
    | SaleTranslations_translations_edges_node_SaleTranslatableContent;
