...
export type CategoryTranslations_translations_edges_node =
    | CategoryTranslations_translations_edges_node_ProductTranslatableContent
    | CategoryTranslations_translations_edges_node_CategoryTranslatableContent;
