...
export type VoucherTranslations_translations_edges_node =
    | VoucherTranslations_translations_edges_node_ProductTranslatableContent
    | VoucherTranslations_translations_edges_node_VoucherTranslatableContent;
