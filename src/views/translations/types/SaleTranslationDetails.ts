...
export type SaleTranslationDetails_translation =
    | SaleTranslationDetails_translation_ProductTranslatableContent
    | SaleTranslationDetails_translation_SaleTranslatableContent;
