...
import { buttonMessages, ListProps } from "@mzawadie/core";
import { TranslationField } from "@mzawadie/views/translations/types";
...
type Pagination = Pick<ListProps, Exclude<keyof ListProps, "onRowClick" | "disabled">>;
                ...
                <CardContent className={classes.cardContent}>
                    <Grid className={classes.grid} variant="uniform">
                        <Typography className={classes.columnHeader} variant="body1">
                            <FormattedMessage defaultMessage="Original String" id="Xtd0AT" />
                        </Typography>
                        <Typography className={classes.columnHeader} variant="body1">
                            <FormattedMessage
