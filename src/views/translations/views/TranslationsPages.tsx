...
import { TypedUpdateAttributeValueTranslations, TypedUpdatePageTranslations } from "../mutations";
...
const TranslationsPages: React.FC<TranslationsPagesProps> = ({ id, languageCode, params }) => {
    ...
    return (
        <TypedUpdatePageTranslations onCompleted={(data) => onUpdate(data.pageTranslate.errors)}>
