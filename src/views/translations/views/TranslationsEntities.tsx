...
const sumCompleted = (list: any[]) => list.reduce((acc, field) => acc + (field ? 1 : 0), 0);
                    ...
                    {({ data, loading }) => {
                        ...
                        return (
                            <TranslationsEntitiesList
                                ...
                                onRowClick={(id) =>
                                    navigate(
                                        languageEntityUrl(language, TranslatableEntities.categories, id)
                                    )
                                }
                    ...
                    {({ data, loading }) => {
                        ...
                        return (
                            <TranslationsEntitiesList
                                ...
                                onRowClick={(id) =>
                                    navigate(
                                        languageEntityUrl(language, TranslatableEntities.products, id)
                                    )
                                }
                                onNextPage={loadNextPage}
                                onPreviousPage={loadPreviousPage}
                    ...
                    {({ data, loading }) => {
                        ...
                        return (
                            <TranslationsEntitiesList
                                ...
                                onRowClick={(id) =>
                                    navigate(
                                        languageEntityUrl(language, TranslatableEntities.vouchers, id)
                                    )
                                }
                                onNextPage={loadNextPage}
                                onPreviousPage={loadPreviousPage}
                    ...
                    {({ data, loading }) => {
                        ...
                        return (
                            <TranslationsEntitiesList
                                ...
                                onRowClick={(id) =>
                                    navigate(
                                        languageEntityUrl(language, TranslatableEntities.attributes, id)
                                    )
                                }
                                onNextPage={loadNextPage}
                                onPreviousPage={loadPreviousPage}
