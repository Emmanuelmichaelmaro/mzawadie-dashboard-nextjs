...
import WebhooksRoutes from "@mzawadie/views/webhooks";
...
const AppDetailsSettings: React.FC<RouteComponentProps<{ id: string }>> = ({ match }) => (
    ...
    return (
        <>
            ...
            <Switch>
                ...
                <Route exact path={appSettingsPath(":id")} component={AppDetailsSettings} />
                <Route
                    exact
