// @ts-nocheck
import { PageTypeListUrlQueryParams, PageTypeUrlQueryParams } from "@mzawadie/views/pageTypes/urls";
import { usePageCountQuery } from "@mzawadie/views/pages/queries";
import { PageCountVariables } from "@mzawadie/views/pages/types/PageCount";
