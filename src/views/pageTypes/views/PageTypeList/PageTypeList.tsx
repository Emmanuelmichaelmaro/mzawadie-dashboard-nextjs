...
import usePageTypeDelete from "@mzawadie/views/pageTypes/hooks/usePageTypeDelete";
import { usePageTypeBulkDeleteMutation } from "@mzawadie/views/pageTypes/mutations";
