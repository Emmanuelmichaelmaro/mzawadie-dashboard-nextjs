...
import { shippingMethodFragment, shippingZoneDetailsFragment } from "@mzawadie/fragments/shipping";
...
import { CreateShippingRate, CreateShippingRateVariables } from "./types/CreateShippingRate";
import { CreateShippingZone, CreateShippingZoneVariables } from "./types/CreateShippingZone";
import { DeleteShippingRate, DeleteShippingRateVariables } from "./types/DeleteShippingRate";
import { DeleteShippingZone, DeleteShippingZoneVariables } from "./types/DeleteShippingZone";
import {
...
import { UpdateShippingRate, UpdateShippingRateVariables } from "./types/UpdateShippingRate";
import { UpdateShippingZone, UpdateShippingZoneVariables } from "./types/UpdateShippingZone";
...
`;
export const useShippingZoneDelete = makeMutation<DeleteShippingZone, DeleteShippingZoneVariables>(
    deleteShippingZone
);
...
`;
export const useShippingZoneCreate = makeMutation<CreateShippingZone, CreateShippingZoneVariables>(
    createShippingZone
);
...
`;
export const useShippingZoneUpdate = makeMutation<UpdateShippingZone, UpdateShippingZoneVariables>(
    updateShippingZone
);
...
`;
export const useShippingRateUpdate = makeMutation<UpdateShippingRate, UpdateShippingRateVariables>(
    updateShippingRate
);
...
`;
export const useShippingRateCreate = makeMutation<CreateShippingRate, CreateShippingRateVariables>(
    createShippingRate
);
...
`;
export const useShippingRateDelete = makeMutation<DeleteShippingRate, DeleteShippingRateVariables>(
    deleteShippingRate
);
