...
export interface CreateShippingRate_shippingPriceCreate_shippingZone_shippingMethods {
    ...
    id: string;
    postalCodeRules:
        | (CreateShippingRate_shippingPriceCreate_shippingZone_shippingMethods_postalCodeRules | null)[]
        | null;
...
export interface CreateShippingRate_shippingPriceCreate_shippingMethod {
    ...
    id: string;
    postalCodeRules:
        | (CreateShippingRate_shippingPriceCreate_shippingMethod_postalCodeRules | null)[]
        | null;
