...
import { PermissionGroupList_permissionGroups_edges_node } from "@mzawadie/views/permissionGroups/types/PermissionGroupList";
                    ...
                    (permissionGroup) => (
                        ...
                        >
                            ...
                            <TableCell className={classes.colMembers}>
                                {permissionGroup ? (
                                    <span data-test="members">{permissionGroup?.users?.length}</span>
                                ) : (
                                    <Skeleton />
                                )}
                            </TableCell>
