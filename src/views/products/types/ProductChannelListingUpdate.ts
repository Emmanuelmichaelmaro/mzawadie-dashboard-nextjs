...
export interface ProductChannelListingUpdate_productChannelListingUpdate_product_variants {
    ...
    id: string;
    channelListings:
        | ProductChannelListingUpdate_productChannelListingUpdate_product_variants_channelListings[]
        | null;
}
...
export interface ProductChannelListingUpdate_productChannelListingUpdate_product {
    ...
    id: string;
    channelListings:
        | ProductChannelListingUpdate_productChannelListingUpdate_product_channelListings[]
        | null;
    variants:
        | (ProductChannelListingUpdate_productChannelListingUpdate_product_variants | null)[]
        | null;
}
