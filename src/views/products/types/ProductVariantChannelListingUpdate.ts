...
export interface ProductVariantChannelListingUpdate_productVariantChannelListingUpdate_variant_product {
    ...
    id: string;
    channelListings:
        | ProductVariantChannelListingUpdate_productVariantChannelListingUpdate_variant_product_channelListings[]
        | null;
}
...
export interface ProductVariantChannelListingUpdate_productVariantChannelListingUpdate_variant {
    ...
    id: string;
    channelListings:
        | ProductVariantChannelListingUpdate_productVariantChannelListingUpdate_variant_channelListings[]
        | null;
