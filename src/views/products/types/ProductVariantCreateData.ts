...
export interface ProductVariantCreateData_product_productType {
    ...
    selectionVariantAttributes:
        | (ProductVariantCreateData_product_productType_selectionVariantAttributes | null)[]
        | null;
    nonSelectionVariantAttributes:
        | (ProductVariantCreateData_product_productType_nonSelectionVariantAttributes | null)[]
        | null;
}
