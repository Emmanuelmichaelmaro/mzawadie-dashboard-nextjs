...
} from "@mzawadie/views/channels/pages/ChannelDetailsPage/utils";
...
export const getChannelWithAddedVariantData = ({
    channelWithVariantsData: { selectedVariantsIds, variantsIdsToAdd, variantsIdsToRemove },
    channelId,
    variantId,
    ...
    [channelId]: {
        ...
        variantsIdsToRemove: getUpdatedIdsWithoutNewId(variantsIdsToRemove, variantId),
    },
});
...
export const getChannelWithRemovedVariantData = ({
    ...
    [channelId]: {
        selectedVariantsIds: getUpdatedIdsWithoutNewId(selectedVariantsIds, variantId),
...
export const extractAllProductVariantsIds = (productVariants: ProductDetails_product_variants[] = []) =>
...
export const getTotalSelectedChannelsCount = (channelsWithVariantsData: ChannelsWithVariantsData) =>
    reduce(
        channelsWithVariantsData,
        (result, { selectedVariantsIds }) => (selectedVariantsIds.length ? result + 1 : result),
        0
    );
