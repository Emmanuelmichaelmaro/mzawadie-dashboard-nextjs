...
const useChannelsWithProductVariants = ({
    ...
    const initialChannelsWithVariantsData = getParsedChannelsWithVariantsDataFromChannels(channels);

    const [channelsWithVariantsData, setChannelsWithVariantsData] =
        useStateFromProps<ChannelsWithVariantsData>(initialChannelsWithVariantsData);
    ...
    const toggleAllChannelVariants = (channelId: string) => () => {
        const isChannelSelected = areAnyChannelVariantsSelected(channelsWithVariantsData[channelId]);
    ...
    const handleModalOpen = () => openModal(CHANNELS_AVAILIABILITY_MODAL_SELECTOR);
