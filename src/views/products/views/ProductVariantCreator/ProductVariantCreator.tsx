...
import { useProductVariantBulkCreateMutation } from "@mzawadie/views/products/mutations";
import { useCreateMultipleVariantsData } from "@mzawadie/views/products/queries";
