...
import { mapEdgesToItems, mapNodeToChoice, mapSlugNodeToChoice } from "@mzawadie/utils/maps";
import {
    ProductFilterKeys,
    ProductListFilterOpts,
} from "@mzawadie/views/products/components/ProductListPage";
import { InitialProductFilterAttributes_attributes_edges_node } from "@mzawadie/views/products/types/InitialProductFilterAttributes";
import { InitialProductFilterCategories_categories_edges_node } from "@mzawadie/views/products/types/InitialProductFilterCategories";
import { InitialProductFilterCollections_collections_edges_node } from "@mzawadie/views/products/types/InitialProductFilterCollections";
import { InitialProductFilterProductTypes_productTypes_edges_node } from "@mzawadie/views/products/types/InitialProductFilterProductTypes";
import {
    SearchAttributeValues,
    SearchAttributeValuesVariables,
} from "@mzawadie/views/searches/types/SearchAttributeValues";
import {
    SearchCategories,
    SearchCategoriesVariables,
} from "@mzawadie/views/searches/types/SearchCategories";
import {
    SearchCollections,
    SearchCollectionsVariables,
} from "@mzawadie/views/searches/types/SearchCollections";
import {
    SearchProductTypes,
    SearchProductTypesVariables,
} from "@mzawadie/views/searches/types/SearchProductTypes";
...
const parseFilterValue = (
    ...
    const isBooleanValue = !isMulti && ["true", "false"].includes(value as unknown as string);
...
function getFilteredAttributeValue(
    ...
    BooleanFilterParam | BaseFilterParam | DateTimeFilterParam | DateFilterParam | DefaultFilterParam
> {
