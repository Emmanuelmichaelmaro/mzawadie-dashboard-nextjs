...
import { ProductDetails_product } from "@mzawadie/views/products/types/ProductDetails";
import {
...
function useProductUpdateForm(
    ...
    const submit = async () => handleFormSubmit(getSubmitData(), handleSubmit, setChanged);
