...
export interface ProductVariantCreatorPriceAndSkuProps {
    ...
    onApplyToAllChange: (value: VariantCreatorPricesAndSkuMode, type: PriceOrStock) => void;
    ...
    onAttributePriceChange: (id: string, value: string, channelId: string) => void;
    onAttributeStockChange: (id: string, quantity: number, warehouseIndex: number) => void;
