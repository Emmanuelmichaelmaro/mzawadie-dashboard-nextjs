...
import { orderListUrl } from "@mzawadie/views/orders/urls";
import { productListUrl, productVariantEditUrl } from "@mzawadie/views/products/urls";
...
const HomeSection = () => {
    ...
    return (
        <HomePage
            ...
            onProductClick={(productId: string, variantId: string) =>
