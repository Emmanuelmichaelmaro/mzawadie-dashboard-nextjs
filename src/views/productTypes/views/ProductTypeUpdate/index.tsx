...
import AssignAttributeDialog from "@mzawadie/components/AssignAttributeDialog";
import AttributeUnassignDialog from "@mzawadie/components/AttributeUnassignDialog";
import BulkAttributeUnassignDialog from "@mzawadie/components/BulkAttributeUnassignDialog";
...
import { attributeUrl } from "@mzawadie/views/attributes/urls";
import useProductTypeDelete from "@mzawadie/views/productTypes/hooks/useProductTypeDelete";
import { useProductTypeUpdateMutation } from "@mzawadie/views/productTypes/mutations";
    ...
    return (
        <TypedProductTypeDetailsQuery displayLoader variables={{ id }}>
            {({ data, loading: dataLoading }) => {
                ...
                const handleAttributeUnassignSuccess = (data: UnassignProductAttribute) => {
                ...
                const handleProductTypeDeleteSuccess = (deleteData: ProductTypeDelete) => {
