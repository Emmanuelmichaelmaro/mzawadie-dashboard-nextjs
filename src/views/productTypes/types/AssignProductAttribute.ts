...
export interface AssignProductAttribute_productAttributeAssign_productType {
    ...
    productAttributes:
        | (AssignProductAttribute_productAttributeAssign_productType_productAttributes | null)[]
        | null;
    variantAttributes:
        | (AssignProductAttribute_productAttributeAssign_productType_variantAttributes | null)[]
        | null;
