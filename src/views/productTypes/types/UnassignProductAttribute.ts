...
export interface UnassignProductAttribute_productAttributeUnassign_productType {
    ...
    productAttributes:
        | (UnassignProductAttribute_productAttributeUnassign_productType_productAttributes | null)[]
        | null;
    variantAttributes:
        | (UnassignProductAttribute_productAttributeUnassign_productType_variantAttributes | null)[]
        | null;
