...
import { PartialMutationProviderOutput, getMutationProviderData } from "@mzawadie/core";
import {
    ProductTypeDetailsFragment,
    ProductTypeDetailsFragment_productAttributes,
} from "@mzawadie/fragments/types/ProductTypeDetailsFragment";
import { ProductAttributeType, ReorderInput } from "@mzawadie/types/globalTypes";
...
import { ProductTypeDelete, ProductTypeDeleteVariables } from "../types/ProductTypeDelete";
import {
    UnassignProductAttribute,
    UnassignProductAttributeVariables,
} from "../types/UnassignProductAttribute";

function moveAttribute(attributes: ProductTypeDetailsFragment_productAttributes[], move: ReorderInput) {
...
interface ProductTypeOperationsProps {
    children: (props: {
        ...
        unassignAttribute: PartialMutationProviderOutput<
            ...
            UnassignProductAttributeVariables
        >;
        deleteProductType: PartialMutationProviderOutput<ProductTypeDelete, ProductTypeDeleteVariables>;
    ...
    <TypedProductTypeDeleteMutation onCompleted={onProductTypeDelete}>
        {(...deleteProductType) => (
            <TypedAssignProductAttributeMutation onCompleted={onAssignAttribute}>
                {(...assignAttribute) => (
                    <TypedUnassignProductAttributeMutation onCompleted={onUnassignAttribute}>
                        {(...unassignAttribute) => (
                            <ProductTypeAttributeReorderMutation
