...
export interface OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_fulfillment {
    ...
    id: string;
    lines:
        | (OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_fulfillment_lines | null)[]
        | null;
...
export interface OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_order_events {
    ...
    lines:
        | (OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_order_events_lines | null)[]
        | null;
}
...
export interface OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_order_fulfillments {
    ...
    id: string;
    lines:
        | (OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_order_fulfillments_lines | null)[]
        | null;
    fulfillmentOrder: number;
    status: FulfillmentStatus;
    trackingNumber: string;
...
export interface OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_order {
    ...
    events:
        | (OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_order_events | null)[]
        | null;
    ...
    availableShippingMethods:
        | (OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_order_availableShippingMethods | null)[]
        | null;
    invoices:
        | (OrderFulfillmentRefundProducts_orderFulfillmentRefundProducts_order_invoices | null)[]
        | null;
