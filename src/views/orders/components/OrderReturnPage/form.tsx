...
import { OrderDetails_order } from "@mzawadie/views/orders/types/OrderDetails";
...
function useOrderReturnForm(
    ...
    const getItemsToBeReplaced = () => {
        ...
        return [...orderLinesItems, ...refundedFulfilmentsItems, ...fulfilledFulfillmentsItems];
    };
    ...
    const handleSetMaximalFulfiledItemsQuantities = (fulfillmentId: string) => () => {
        ...
        const newQuantities: FormsetQuantityData = fulfiledItemsQuatities.data.map((item) => {
