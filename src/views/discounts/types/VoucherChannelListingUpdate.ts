...
export interface VoucherChannelListingUpdate_voucherChannelListingUpdate_voucher {
    ...
    countries:
        | (VoucherChannelListingUpdate_voucherChannelListingUpdate_voucher_countries | null)[]
        | null;
    minCheckoutItemsQuantity: number | null;
    channelListings:
        | VoucherChannelListingUpdate_voucherChannelListingUpdate_voucher_channelListings[]
        | null;
}
