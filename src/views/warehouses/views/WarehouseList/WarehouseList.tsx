...
import WarehouseListPage from "@mzawadie/views/warehouses/components/WarehouseListPage";
import { useWarehouseDelete } from "@mzawadie/views/warehouses/mutations";
