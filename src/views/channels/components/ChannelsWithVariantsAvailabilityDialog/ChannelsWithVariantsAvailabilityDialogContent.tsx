...
import IconCheckboxChecked from "@mzawadie/icons/CheckboxChecked";
import IconCheckboxSemiChecked from "@mzawadie/icons/CheckboxSemiChecked";
import IconChevronDown from "@mzawadie/icons/ChevronDown";
import { ChannelData } from "@mzawadie/views/channels/utils";
import Label from "@mzawadie/views/orders/components/OrderHistory/Label";
...
import { areAllChannelVariantsSelected } from "@mzawadie/views/products/views/ProductUpdate/utils";
...
const ChannelsWithVariantsAvailabilityDialogContent: React.FC<ChannelsWithVariantsAvailabilityDialogContentProps> =
    ({
        ...
        const selectChannelIcon = (channelId: string) =>
            areAllChannelVariantsSelected(allVariants, channelsWithVariants[channelId]) ? (
                <IconCheckboxChecked />
            ) : (
            ...
            <>
                {map(channelsWithVariants, ({ selectedVariantsIds }, channelId) => {
                    ...
                    const getVariantThumbnailSrc = (variantId: string) =>
                        allVariants.find(getById(variantId)).media[0]?.url || placeholderImage;

                    return (
                        <ExpansionPanel classes={expanderClasses} data-test-id="expand-channel-row">
