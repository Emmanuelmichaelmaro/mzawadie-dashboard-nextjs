...
import ChannelDeleteDialog from "@mzawadie/views/channels/components/ChannelDeleteDialog";
import { FormData } from "@mzawadie/views/channels/components/ChannelForm/ChannelForm";
import { ChannelDelete } from "@mzawadie/views/channels/types/ChannelDelete";
...
import { useChannelShippingZones } from "@mzawadie/views/shipping/queries";
...
export const ChannelDetails: React.FC<ChannelDetailsProps> = ({ id, params }) => {
    ...
    const handleSubmit = ({ name, slug, shippingZonesIdsToRemove, shippingZonesIdsToAdd }: FormData) =>
        updateChannel({
            variables: {
                id: data?.channel.id,
                input: {
