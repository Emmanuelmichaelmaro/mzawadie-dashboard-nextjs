...
import { useProductVariantSetDefaultMutation } from "@mzawadie/views/products/mutations";
import { ProductDetails_product_variants } from "@mzawadie/views/products/types/ProductDetails";
import { VariantUpdate_productVariantUpdate_productVariant } from "@mzawadie/views/products/types/VariantUpdate";
