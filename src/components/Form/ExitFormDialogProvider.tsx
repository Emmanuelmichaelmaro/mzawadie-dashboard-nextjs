// @ts-nocheck
import { isInDevelopment } from "@mzawadie/core";
...
export function useExitFormDialogProvider() {
    ...
    const hasAnySubmitFn = () => getFormsDataValuesArray().some(({ submitFn }) => !!submitFn);
    ...
    const handleSubmit = async () => {
        ...
        const errors = await Promise.all(getDirtyFormsSubmitFn().map((submitFn) => submitFn()));
