...
import { isExternalURL } from "@mzawadie/utils/urls";
...
export interface TableRowLinkProps extends Omit<MaterialTableRowPropsType, "onClick"> {
...
const TableRowLink = ({ href, children, linkClassName, ...props }: TableRowLinkProps) => {
