...
const MultiAutocompleteSelectFieldContent: React.FC<MultiAutocompleteSelectFieldContentProps> = (
    props
) => {
    const {
        add,
    ...
    return (
        <Paper className={classes.root} elevation={8}>
                            ...
                            return (
                                ...
                                >
                                    <Checkbox
                                        ...
                                        disableRipple
                                    />
                                    <span className={classes.menuItemLabel}>{suggestion.label}</span>
                                </MenuItem>
                            );
                        })}
                    </>
            ...
            {!loading && !hasValuesToDisplay && (
                <MenuItem disabled component="div" data-test-id="multi-autocomplete-select-no-options">
