...
import { FetchMoreProps, buttonMessages } from "@mzawadie/core";
import useElementScroll from "@mzawadie/hooks/useElementScroll";
...
const ColumnPickerContent: React.FC<ColumnPickerContentProps> = (props) => {
    ...
    const dropShadow =
        anchor.current && scrollPosition
            ? scrollPosition.y + anchor.current.clientHeight < anchor.current.scrollHeight
            : false;
    ...
    return (
        <Card className={classes.root}>
            ...
            <Hr />
            <CardContent className={classes.contentContainer} ref={anchor} id={scrollableTargetId}>
                <InfiniteScroll
                ...
                >
                    <div className={classes.content}>
                        {columns.map((column) => (
                            <ControlledCheckbox
                                checked={isSelected(column.value, selectedColumns, (a, b) => a === b)}
                                name={column.value}
                                label={column.label}
            ...
            >
                <div className={classes.actionBar}>
                    <Button color="default" onClick={onReset}>
                        <FormattedMessage defaultMessage="Reset" id="TOMgXz" description="button" />
                    </Button>
                    <div>
                        <Button className={classes.cancelButton} color="default" onClick={onCancel}>
