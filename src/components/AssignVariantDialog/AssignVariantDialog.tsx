...
import { maybe, renderCollection, DialogProps, FetchMoreProps } from "@mzawadie/core";
...
} from "@mzawadie/searches/types/SearchProducts";
...
type SetVariantsAction = (data: SearchProducts_search_edges_node_variants[]) => void;
...
const AssignVariantDialog: React.FC<AssignVariantDialogProps> = (props) => {
    ...
    const [variants, setVariants] = React.useState<SearchProducts_search_edges_node_variants[]>([]);
