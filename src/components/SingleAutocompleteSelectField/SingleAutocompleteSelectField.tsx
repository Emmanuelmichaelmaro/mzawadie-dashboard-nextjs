...
import/no-named-as-default,import/no-cycle */
...
import { ExtendedFormHelperTextProps } from "@mzawadie/views/channels/components/ChannelForm/types";
...
const SingleAutocompleteSelectFieldComponent: React.FC<SingleAutocompleteSelectFieldProps> = (
    props
) => {
    const {
        add,
