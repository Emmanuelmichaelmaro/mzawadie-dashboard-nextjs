...
export interface NavigatorButtonProperties extends IconButtonProps {
    isMac: boolean;
}

const NavigatorButton: React.FC<NavigatorButtonProperties> = ({ className, isMac, ...properties }) => {
                ...
                {({ TransitionProps, placement }) => (
                    ...
                    >
                        <Paper className={classes.paper} elevation={0}>
                            <FormattedMessage defaultMessage="Navigator" id="EEW+ND" />
