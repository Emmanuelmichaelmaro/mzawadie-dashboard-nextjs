...
import { addAllVariantsToAllChannels, getChannelVariantToggleData } from "./utils";
...
const useChannelsWithProductVariants = (
    ...
    const toggleAllChannels = () =>
        setChannelVariantListing((listings) => addAllVariantsToAllChannels(listings, variants));
