...
import { getVariantChannelsInputs } from "@mzawadie/pages/products/components/ProductVariants/datagrid/getVariantChannelsInputs";
import {
    getStockInputs,
    getStocks,
    getVariantChannels,
    getVariantInput,
    getVariantInputs,
} from "@mzawadie/pages/products/components/ProductVariants/utils";
...
export function useProductUpdateHandler(
    ...
    const [updateVariantChannels] = useVariantDatagridChannelListingUpdateMutation();
