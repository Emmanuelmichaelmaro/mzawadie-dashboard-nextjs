...
import { hasMutationErrors } from "@mzawadie/core";
import {
    ...
    return [productChannelsUpdateResult, ...variantMutationResults]
        ...
        .flatMap((result) => {
            ...
            if (result.data.productVariantStocksUpdate) {
                ...
                return [
                    ...data.productVariantStocksUpdate.errors.map<ProductVariantListError>((error) => ({
                        __typename: "DatagridError",
                        type: "stock",
                        variantId: (variables as VariantDatagridStockUpdateMutationVariables).id,
            ...
            if (result.data.productVariantUpdate) {
                ...
                return data.productVariantUpdate.errors.map<ProductVariantListError>((error) => ({
                    __typename: "DatagridError",
                    type: "variantData",
            ...
            if (result.data.productVariantBulkCreate) {
                ...
                return data.productVariantBulkCreate.errors.map<ProductVariantListError>((error) => ({
                    __typename: "DatagridError",
                    type: "create",
                    index: error.index,
                    error: error.code,
