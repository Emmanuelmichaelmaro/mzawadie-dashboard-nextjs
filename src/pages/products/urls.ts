...
export type ProductCreateUrlQueryParams = Dialog<ProductCreateUrlDialog> & SingleAction;
...
export const productImageUrl = (
    ...
    `${productImagePath(encodeURIComponent(productId), encodeURIComponent(imageId))}?${stringifyQs(
        params
    )}`;
