...
import { ProductExternalMediaDialog } from "@mzawadie/pages/products/components/ProductExternalMediaDialog";
import { productImageUrl, productListUrl } from "@mzawadie/pages/products/urls";
