...
const useStyles = makeStyles(
    (theme) => ({
        attrInputsContainer: {
            display: "grid",
            gap: theme.spacing(2),
            gridTemplateColumns: "minmax(80px, 150px) repeat(auto-fit, minmax(150px, 250px))",
        },
        channelName: {
...
export interface ProductVariantCreatorPricesProps {
    ...
    onAttributeValueChange: (id: string, value: string, channelId: string) => void;
}
