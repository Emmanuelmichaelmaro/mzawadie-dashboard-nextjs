...
import { ChannelFragment, ExportProductsInput, ProductFieldEnum } from "@mzawadie/graphql";
        ...
        <>
            <Typography className={classes.dialogLabel}>
                <FormattedMessage
                    ...
                    id="iQVghC"
                    description="select product information\'s to be exported"
                />
            </Typography>
            ...
            <div className={classes.scrollArea}>
                ...
                <FieldAccordion
                    ...
                    title={intl.formatMessage({
                        ...
                        id: "sxCmsG",
                        description: "information's about product organization, header",
                    })}
                    data={data}
                    fields={[
                ...
                <FieldAccordion
                    ...
                    title={intl.formatMessage({
                        ...
                        id: "Kb86Y2",
                        description: "information's about product prices etc, header",
                    })}
                    data={data}
