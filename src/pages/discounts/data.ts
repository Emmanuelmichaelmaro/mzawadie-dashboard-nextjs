// @ts-nocheck
import { VoucherChannelListingAddInput } from "@mzawadie/graphql";
...
const getChannelDiscountValue = (channel: ChannelVoucherData, formData: VoucherDetailsPageFormData) =>
