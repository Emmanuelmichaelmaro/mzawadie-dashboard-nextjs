...
import { InvoiceEmailSend, InvoiceEmailSendVariables } from "./types/InvoiceEmailSend";
import { InvoiceRequest, InvoiceRequestVariables } from "./types/InvoiceRequest";
...
import { OrderDiscountAdd, OrderDiscountAddVariables } from "./types/OrderDiscountAdd";
import { OrderDiscountDelete, OrderDiscountDeleteVariables } from "./types/OrderDiscountDelete";
import { OrderDiscountUpdate, OrderDiscountUpdateVariables } from "./types/OrderDiscountUpdate";
import { OrderDraftBulkCancel, OrderDraftBulkCancelVariables } from "./types/OrderDraftBulkCancel";
import { OrderDraftCancel, OrderDraftCancelVariables } from "./types/OrderDraftCancel";
import { OrderDraftCreate, OrderDraftCreateVariables } from "./types/OrderDraftCreate";
import { OrderDraftFinalize, OrderDraftFinalizeVariables } from "./types/OrderDraftFinalize";
...
import { OrderLineDelete, OrderLineDeleteVariables } from "./types/OrderLineDelete";
import {
...
import { OrderLineUpdate, OrderLineUpdateVariables } from "./types/OrderLineUpdate";
import { OrderLinesAdd, OrderLinesAddVariables } from "./types/OrderLinesAdd";
import { OrderMarkAsPaid, OrderMarkAsPaidVariables } from "./types/OrderMarkAsPaid";
import { OrderRefund, OrderRefundVariables } from "./types/OrderRefund";
import { OrderSettingsUpdate, OrderSettingsUpdateVariables } from "./types/OrderSettingsUpdate";
import {
...
`;
export const TypedOrderCancelMutation = TypedMutation<OrderCancel, OrderCancelVariables>(
    orderCancelMutation
);
...
export const useOrderDiscountAddMutation = makeMutation<OrderDiscountAdd, OrderDiscountAddVariables>(
...
`;
export const TypedOrderDraftCancelMutation = TypedMutation<OrderDraftCancel, OrderDraftCancelVariables>(
...
export const useOrderConfirmMutation = makeMutation<OrderConfirm, OrderConfirmVariables>(
...
export const useOrderRefundMutation = makeMutation<OrderRefund, OrderRefundVariables>(
    orderRefundMutation
);
...
`;
export const TypedOrderCaptureMutation = TypedMutation<OrderCapture, OrderCaptureVariables>(
...
`;
export const TypedOrderAddNoteMutation = TypedMutation<OrderAddNote, OrderAddNoteVariables>(
...
`;
export const TypedOrderUpdateMutation = TypedMutation<OrderUpdate, OrderUpdateVariables>(
    orderUpdateMutation
);
...
`;
export const TypedOrderDraftUpdateMutation = TypedMutation<OrderDraftUpdate, OrderDraftUpdateVariables>(
...
`;
export const useOrderDraftCreateMutation = makeMutation<OrderDraftCreate, OrderDraftCreateVariables>(
...
`;
export const TypedOrderLineDeleteMutation = TypedMutation<OrderLineDelete, OrderLineDeleteVariables>(
...
`;
export const TypedOrderLinesAddMutation = TypedMutation<OrderLinesAdd, OrderLinesAddVariables>(
...
`;
export const TypedOrderLineUpdateMutation = TypedMutation<OrderLineUpdate, OrderLineUpdateVariables>(
...
`;
export const useOrderFulfill = makeMutation<FulfillOrder, FulfillOrderVariables>(fulfillOrder);
...
`;
export const TypedInvoiceRequestMutation = TypedMutation<InvoiceRequest, InvoiceRequestVariables>(
...
`;
export const TypedInvoiceEmailSendMutation = TypedMutation<InvoiceEmailSend, InvoiceEmailSendVariables>(
