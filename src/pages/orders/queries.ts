...
import { OrderFulfillData, OrderFulfillDataVariables } from "./types/OrderFulfillData";
import { OrderFulfillSettings } from "./types/OrderFulfillSettings";
import { OrderList, OrderListVariables } from "./types/OrderList";
import { OrderRefundData, OrderRefundDataVariables } from "./types/OrderRefundData";
...
`;
export const useOrderListQuery = makeQuery<OrderList, OrderListVariables>(orderListQuery);
...
`;
export const useOrderDraftListQuery = makeQuery<OrderDraftList, OrderDraftListVariables>(
    orderDraftListQuery
);
...
export const TypedOrderDetailsQuery = TypedQuery<OrderDetails, OrderDetailsVariables>(
    orderDetailsQuery
);

export const useOrderQuery = makeQuery<OrderDetails, OrderDetailsVariables>(orderDetailsQuery);
...
`;
export const useOrderFulfillData = makeQuery<OrderFulfillData, OrderFulfillDataVariables>(
    orderFulfillData
);
...
`;
export const useOrderFulfillSettingsQuery = makeQuery<OrderFulfillSettings, never>(
...
`;
export const useOrderSettingsQuery = makeQuery<OrderSettings, never>(orderSettingsQuery);
...
`;
export const useOrderRefundData = makeQuery<OrderRefundData, OrderRefundDataVariables>(orderRefundData);
