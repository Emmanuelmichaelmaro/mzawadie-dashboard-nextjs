import { UseBulkActionsProps } from "@mzawadie/hooks/useBulkActions";
import { useContext } from "react";

import { GiftCardsListConsumerProps, GiftCardsListContext } from "../GiftCardListProvider";
...
const useGiftCardListBulkActions = (): UseGiftCardListBulkActionsProps => {
    const { isSelected, listElements, reset, toggleAll, toggle, selectedItemsCount } =
