...
import { AttributeTranslations, AttributeTranslationsVariables } from "./types/AttributeTranslations";
import {
    CategoryTranslationDetails,
    CategoryTranslationDetailsVariables,
} from "./types/CategoryTranslationDetails";
import { CategoryTranslations, CategoryTranslationsVariables } from "./types/CategoryTranslations";
import {
...
import { PageTranslations, PageTranslationsVariables } from "./types/PageTranslations";
import {
    ProductTranslationDetails,
    ProductTranslationDetailsVariables,
} from "./types/ProductTranslationDetails";
import { ProductTranslations, ProductTranslationsVariables } from "./types/ProductTranslations";
import { ProductVariantList, ProductVariantListVariables } from "./types/ProductVariantList";
import {
...
import { SaleTranslations, SaleTranslationsVariables } from "./types/SaleTranslations";
import {
...
import { VoucherTranslations, VoucherTranslationsVariables } from "./types/VoucherTranslations";
...
`;
export const TypedProductTranslations = TypedQuery<ProductTranslations, ProductTranslationsVariables>(
    productTranslations
);
...
`;
export const TypedPageTranslations = TypedQuery<PageTranslations, PageTranslationsVariables>(
    pageTranslations
);
...
`;
export const TypedVoucherTranslations = TypedQuery<VoucherTranslations, VoucherTranslationsVariables>(
    voucherTranslations
);
...
`;
export const TypedSaleTranslations = TypedQuery<SaleTranslations, SaleTranslationsVariables>(
    saleTranslations
);
...
`;
export const useProductVariantList = makeQuery<ProductVariantList, ProductVariantListVariables>(
    productVariantList
);
