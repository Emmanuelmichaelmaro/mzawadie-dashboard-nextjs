...
import { TypedUpdateAttributeValueTranslations, TypedUpdateProductTranslations } from "../mutations";
...
const TranslationsProducts: React.FC<TranslationsProductsProps> = ({ id, languageCode, params }) => {
    ...
    return (
        <TypedUpdateProductTranslations onCompleted={(data) => onUpdate(data.productTranslate.errors)}>
