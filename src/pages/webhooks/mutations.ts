...
export const useWebhookCreateMutation = makeMutation<WebhookCreate, WebhookCreateVariables>(
    webhookCreate
);

export const useWebhookDeleteMutation = makeMutation<WebhookDelete, WebhookDeleteVariables>(
    webhookDelete
);

export const useWebhookUpdateMutation = makeMutation<WebhookUpdate, WebhookUpdateVariables>(
    webhookUpdate
);
