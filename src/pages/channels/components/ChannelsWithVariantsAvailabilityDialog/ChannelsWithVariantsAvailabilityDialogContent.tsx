...
const ChannelsWithVariantsAvailabilityDialogContent: React.FC<
    ChannelsWithVariantsAvailabilityDialogContentProps
> = ({
    ...
    const handleVariantChange = (channelId: string, variantId: string) => (event: ChangeEvent<any>) =>
        event.target.value
    ...
    const isChannelPartiallySelected = (channelId: string) => {
        const selectedVariants = channelVariantListingDiffToDict(channelsWithVariants)[channelId];
