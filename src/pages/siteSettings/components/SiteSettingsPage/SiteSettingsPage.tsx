...
const SiteSettingsPage: React.FC<SiteSettingsPageProps> = (props) => {
    ...
    const initialForm: SiteSettingsPageFormData = {
        ...
        reserveStockDurationAuthenticatedUser: shop?.reserveStockDurationAuthenticatedUser,
                    ...
                    <Container>
                        ...
                        <Grid variant="inverted">
                            <PageSectionHeader
                                ...
                                description={intl.formatMessage(messages.sectionDetailsDescription)}
                            />

                            <SiteDetailsSettingsCard
                                data={data}
                                errors={errors}
                                disabled={disabled}
                                onChange={change}
