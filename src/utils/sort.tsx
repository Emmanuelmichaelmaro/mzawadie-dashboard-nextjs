...
export function getOrderDirection(asc: boolean | undefined): OrderDirection {
    return asc ? OrderDirection.ASC : OrderDirection.DESC;
}

export function getArrowDirection(asc: boolean | undefined): TableCellHeaderArrowDirection {
    return asc ? "asc" : "desc";
}
...
export interface SortingInput<T extends string> {
    direction: OrderDirection;
    field: T;
}

export type GetSortQueryField<TUrlField extends string, TSortField extends string> = (
    sort: TUrlField
) => TSortField;

export type GetSortQueryVariables<TSortField extends string, TParams extends Record<any, any>> = (
    params: TParams
) => SortingInput<TSortField>;
